...
/** 后台组允许的 audience。 */
export const ADMIN_AUDIENCES: readonly JwtAudience[] = [
  JWT_AUDIENCE.ADMIN,
 ...
 * 失败统一 401 + `40101`（不区分「无 token」与「token 无效」，避免枚举）。
 */
export const requireAdminAuth = (
  ...
  return errorResponse(AGENT_ERROR_CODES.TOKEN_MISSING_OR_INVALID, "登录状态无效或已过期");
};
